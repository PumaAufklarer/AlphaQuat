...
from alpha_quat.model.nn.keltner.models.dataset import KeltnerRegimeDataset
...
class _WarmupCosineScheduler:
    def __init__(self, optimizer, warmup_steps, total_steps) -> None:
...
def train(
    ...
    train_dataset: KeltnerRegimeDataset,
    val_dataset: KeltnerRegimeDataset,
    output_dir: Path,
    n_epochs: int = 50,
    batch_size: int = 128,
    lr: float = 1e-3,
